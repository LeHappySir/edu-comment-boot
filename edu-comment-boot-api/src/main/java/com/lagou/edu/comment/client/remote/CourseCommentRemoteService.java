...
import com.lagou.edu.comment.client.dto.CourseCommentDTO;
import com.lagou.edu.comment.client.param.CourseCommentParam;
...
@FeignClient(name = "edu-comment-boot", path = "/comment")
